...
\node[assump, left=0.8cm of LT]
  {Assumptions~3--4\\(minimal composite,\\simple EJA)};
...
published theorems (cited).  The four standing assumptions enter at the
points indicated.  Every step in the chain is either proved in the main
text or deferred to \Cref{app:proofs}.}
\label{fig:chain}
\end{figure}
