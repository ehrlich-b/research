...
\noindent The containment is an equality at the Lie algebra level:
the intersection has dimension~12 (verified by explicit computation of
the common generators in~\cite{TodorovDrenska2018}, Sec.~4), matching
$\dim(\SU{3}_C \times \SU{2} \times \mathrm{U}(1)) = 8 + 3 + 1 = 12$.
...
\begin{itemize}
  ...
  \item Route~B: $\mathrm{U}(1)_Y$ with hypercharge
    $Y = \tfrac{1}{2}(B\!-\!L) + I_3^R$.  The generator $B\!-\!L$
...
and are orthogonal to $\SU{3}_C$ and $\SU{2}$.  The explicit
...
hypercharge $Y$ acts on $\Stenplus$.  This is a computation, not
just a rank count.\ $\therefore$ \textbf{Same $\mathrm{U}(1)$.}
