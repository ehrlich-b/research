...
\noindent Since the intersection contains $\SU{3}_C \times \SU{2}
\times \mathrm{U}(1)$ (dimension~12) and is itself a subgroup of
$\Spin{9}$ (dimension~36) intersected with a 16-dimensional group,
the inclusion is tight: a strictly larger intersection would exceed
the dimension of one of the two factors.  Thus
Eq.~\eqref{eq:F4-intersection} is an equality at the Lie algebra
level.
