...
identification of geometry with state.  This is \emph{necessary}---there
is nothing else the vacuum could be---but it is not a mathematical
derivation.  Specifically, we do not prove the \emph{existence} of a
state whose modular flow defines a smooth geometry, nor its
\emph{uniqueness}.  These are open questions.

This parallels the dissolution of the involution in
Paper~5~\cite{Paper5}: in a pre-geometric framework without external
standards, the structure produced by self-modeling defines the
standard.  The parallel is suggestive but not exact; the involution
dissolution was algebraically forced, whereas the MVEH identification
is a structural argument.
