...
\emph{Causal structure, not Lorentz invariance.}---The Lieb--Robinson
bound provides an emergent \emph{causal structure}---a finite maximum
signaling speed---but not Lorentz invariance.  The lattice has a
preferred frame (the rest frame of the lattice).  Lorentz invariance
of the low-energy effective theory is an output of the Wilsonian
continuum limit (Sec.~\ref{sec:continuum}), not a property of the
lattice itself.  The Lieb--Robinson velocity $\vlr$ sets the
\emph{scale} of the emergent speed of light; the \emph{symmetry}
(Lorentz covariance) is a property of the long-wavelength effective
theory, realized when lattice artifacts are suppressed at
$L \gg a$.
