...
The MVEH---reframed as definitional in Sec.~\ref{sec:mveh}---predicts
...
definitional argument of Sec.~\ref{sec:mveh}---that the vacuum is
defined as the state whose modular flow generates smooth
