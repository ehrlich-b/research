...
1. a **tracked-tree census** — over every *persisted* declaration whose defining
   ...
   modules on disk equals the set imported here *and* equals a pinned 213-name
...
run_cmd do
  ...
  -- equally), so the tracked surface is additionally pinned to this exact 213-name
  ...
  let expectedMods : List Name :=
    [`RadicalRelativity,
     ...
     `RadicalRelativity.DirectSumRestrict,
     `RadicalRelativity.Normality,
     `RadicalRelativity.OrthFamily,
     `RadicalRelativity.EJA.Fundamental,
     `RadicalRelativity.EJA.PseudoTransfer,
     `RadicalRelativity.EJA.ConeTopology,
     `RadicalRelativity.EJA.ThetaAbstract,
     `RadicalRelativity.EJA.HermMatCarrier,
     `RadicalRelativity.EJA.AlbertBridge,
     `RadicalRelativity.Composition.HermInner,
     `RadicalRelativity.OneParameter,
     ...
     `RadicalRelativity.EJA.AlbertLuders,
     ...
     `RadicalRelativity.EJA.Spectral,
     `RadicalRelativity.EJA.TraceForm,
     `RadicalRelativity.EJA.OrderAuto,
     `RadicalRelativity.EJA.Order,
     `RadicalRelativity.EJA.Class,
     `RadicalRelativity.EJA.PeirceSubalgebra,
     `RadicalRelativity.EJA.Rank,
     `RadicalRelativity.EJA.FrameExists,
     `RadicalRelativity.EJA.FramePeirce,
     `RadicalRelativity.EJA.FramePeirceMul,
     `RadicalRelativity.EJA.Connection,
     `RadicalRelativity.EJA.Coordinatize,
     `RadicalRelativity.EJA.CoordinatizeWitness,
     `RadicalRelativity.EJA.HermitianCarrier,
     ...
     `RadicalRelativity.PaperA.CompatibilityBridge,
     ...
     `RadicalRelativity.Octonions,
     `RadicalRelativity.OctonionNucleus,
     `RadicalRelativity.OctonionTrace,
     `RadicalRelativity.Albert.Carrier,
     `RadicalRelativity.Albert.Mul,
     `RadicalRelativity.Albert.Inner,
     `RadicalRelativity.Albert.Jordan,
     `RadicalRelativity.EJA.AlbertCarrier,
     `RadicalRelativity.Composition.Defs,
     `RadicalRelativity.Composition.Instances,
     `RadicalRelativity.Composition.Doubling,
     `RadicalRelativity.Composition.CayleyDickson,
     `RadicalRelativity.Composition.Isomorphisms,
     `RadicalRelativity.Composition.Hurwitz,
     `RadicalRelativity.Composition.Classification,
     `RadicalRelativity.Composition.HermMat]
  ...
  logInfo m!"Census PASS: {diskMods.length} tracked RadicalRelativity modules (== frozen {expectedMods.length}-name manifest), custom axioms exactly {citedAxioms}, every tracked persisted declaration's closure ⊆ {allowed}"
