...
lists above are the abstract layer only; they are a small minority of the 178
modules under `RadicalRelativity/` (179 tracked declaration-bearing modules, counting the
root aggregator; measured 2026-08-23 03:10 EDT, and the audit prints its own denominator —
