...
lists above are the abstract layer only; they are a small minority of the 182
modules under `RadicalRelativity/` (183 tracked declaration-bearing modules, counting the
root aggregator; measured 2026-08-23 04:30 EDT, and the audit prints its own denominator —
