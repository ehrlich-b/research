...
lists above are the abstract layer only; they are a small minority of the 189
modules under `RadicalRelativity/` (190 tracked declaration-bearing modules, counting the
root aggregator; measured 2026-08-23 07:55 EDT, and the audit prints its own denominator —
