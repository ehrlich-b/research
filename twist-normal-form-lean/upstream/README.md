...
1. **Rebase onto Mathlib master.** The file is verified against the Mathlib revision pinned
   in this repo (`v4.33.0`; re-elaborated clean under that pin on 2026-08-22, zero errors and
   zero sorries), which is behind master. Every name it uses must be re-checked
